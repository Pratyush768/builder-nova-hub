    ...
    <header className="sticky top-0 z-40 w-full border-b bg-background/80 backdrop-blur">
      <div className="container flex h-16 items-center justify-between">
        <Link to="/" className="flex items-center gap-2">
          <span className="relative inline-flex h-6 w-6 items-center justify-center rounded-md bg-primary/10 text-primary">
            ...
            <svg viewBox="0 0 24 24" className="h-4 w-4">
              <path d="M12 3l3 6 6 3-6 3-3 6-3-6-6-3 6-3z" fill="currentColor" />
            </svg>
          </span>
          <span className={cn("text-lg font-extrabold tracking-tight")}>Aeris</span>
        </Link>
        <nav className="hidden items-center gap-6 text-sm md:flex">
          ...
          <a href="#sensors" className="text-muted-foreground hover:text-foreground">Sensors</a>
